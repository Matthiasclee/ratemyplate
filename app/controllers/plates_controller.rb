class PlatesController < ApplicationController
  ...
  def create
    ...
    state_names = {"AK"=>"Alaska", "AL"=>"Alabama", "AR"=>"Arkansas", "AZ"=>"Arizona", "CA"=>"California", "CO"=>"Colorado", "CT"=>"Connecticut", "DC"=>"Dc", "DC"=>"D.c.", "DC"=>"Washington dc", "DC"=>"Washington d.c.", "DE"=>"Delaware", "FL"=>"Florida", "GA"=>"Georgia", "HI"=>"Hawaii", "IA"=>"Iowa", "ID"=>"Idaho", "IL"=>"Illinois", "IN"=>"Indiana", "KS"=>"Kansas", "KY"=>"Kentucky", "LA"=>"Louisiana", "MA"=>"Massachusetts", "MD"=>"Maryland", "ME"=>"Maine", "MI"=>"Michigan", "MN"=>"Minnesota", "MO"=>"Missouri", "MS"=>"Mississippi", "MT"=>"Montana", "NC"=>"North carolina", "ND"=>"North dakota", "NE"=>"Nebraska", "NH"=>"New hampshire", "NJ"=>"New jersey", "NM"=>"New mexico", "NV"=>"Nevada", "NY"=>"New york", "OH"=>"Ohio", "OK"=>"Oklahoma", "OR"=>"Oregon", "PA"=>"Pennsylvania", "RI"=>"Rhode island", "SC"=>"South carolina", "SD"=>"South dakota", "TN"=>"Tennessee", "TX"=>"Texas", "UT"=>"Utah", "VA"=>"Virginia", "VT"=>"Vermont", "WA"=>"Washington", "WI"=>"Wisconsin", "WV"=>"West virginia", "WY"=>"Wyoming"}
